                    ...
                    <div className="coFounder">
                        ...
                        <div className=" grid-x grid-margin-x ">
                            ...
                            <div className="cell medium-6">
                                ...
                                <li>Professional Services Manager - 10 Reporting Engineers</li>
                                <li>Cisco DevNet Creator Award 2019</li>
                                <li>Cisco Certified - CCNA, CCNP, CCDA, CCDP - Collaboration Focus</li>
                                <li>Lean In Wonder Women and Lean In Too Regional Leader</li>
                                ...
                                <li> She is married to Jesenko Plecic, a life partner and mother of four boys 18 yrs. old, 15
                                  years old, and 14 years old twins</li>
                                  </ul>
                            </div>
                            ...
                            <div className="cell medium-6 " >
                                ...
                                <li>Lean In India and India Corporate Network- Co-Founder</li>
                                <li>Pencils & Pistons - Founder</li>
                                <li>Strategic Programs and Partnership Consultant at The Star In Me</li>
                                <li>Author - Diary of a Young Blogger and Colored Lens</li>
