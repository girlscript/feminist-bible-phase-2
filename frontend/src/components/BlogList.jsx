                ...
                <div className="hero-section">
                    <div className=" grid-container top">
                        <div className=" grid-x grid-margin-x">
                            ...
                            <div className="cell large-12 head ">
                                <div className="BlogList_header">
                                    ...
                                    <div className=" grid-container top">
                                        <div className=" grid-x grid-margin-x">
                                            ...
                                            <div className="cell large-4 BlogList__img">

                                                <img src={blog_img} alt="blog_img" className="guidelines-card__image" />
                                            </div>

                                            <div className="cell large-4 ">
                                                <div className="BlogList__header">
                                                    <div className="BlogList__header__title">
                                                        <h2>QTPOC In Comics: “Bingo Love” Depicts Black Queer Women’s Romance.</h2>
                                                    </div>
